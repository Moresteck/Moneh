...
public class AccountCurrencies implements Comparable<AccountCurrencies> {
	...
	public void addCurrencyValue(String currency, int add) {
		this.setCurrencyValue(currency, add + getCurrencyValue(currency));
	}

	public void setCurrencyValue(String currency, int set) {
		int value = getCurrencyValue(currency);
		if (value != -1) {
	...
	public void removeCurrencyValue(String remove) {
